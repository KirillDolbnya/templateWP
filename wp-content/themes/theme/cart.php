                    ...
                    <div class="cart__order-delivery">
                        ...
                        <div class="cart__order-delivery--items">
                            <label class="cart__order-delivery--item">
                                <input type="radio" name="delivery" class="cart__order-delivery--item_input" value="Курьер">
                            ...
                            <label class="cart__order-delivery--item">
                                <input type="radio" name="delivery" class="cart__order-delivery--item_input" value="Самовывоз">
                                <div class="cart__order-delivery--item_info">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="cart__order-payment">
                        ...
                        <div class="cart__order-payment--items">
                            <label class="cart__order-payment--item">
                                <input type="radio" name="payment" class="cart__order-payment--item_input" value="Картой при получении">
                            ...
                            <label class="cart__order-payment--item">
                                <input type="radio" name="payment" class="cart__order-payment--item_input" value="Наличными при получении">
                                <div class="cart__order-payment--item_info">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
